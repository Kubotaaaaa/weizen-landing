...
ws08 ผมเขียนว่า "ติดตั้ง P2P แบบไม่ทำ token หลุด" แล้ววันรุ่งขึ้นก็เกิดบทเรียนสดๆ ในห้อง: **มีคนเผลอแปะ AUTH_KEY ลง Discord ถึงสองรอบ** ทั้งที่ทุกคนเตือนกัน. นั่นคือคำตอบที่ชัดที่สุด — ถ้ามีความลับร่วมก้อนหนึ่ง สุดท้ายก็หลุด. คำถามที่ถูกกว่าจึงไม่ใช่ "เก็บ token ยังไงไม่ให้หลุด" แต่คือ **"ทำยังไงให้ไม่มี token ตั้งแต่แรก"**
